    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none dark:prose-invert">
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">{t("sections.lastUpdated.title")}</h2>
          <p className="text-muted-foreground">{t("sections.lastUpdated.content")}</p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">{t("sections.informationWeCollect.personalInfo.content")}</p>

          <h3 className="text-xl font-medium mb-2">
            {t("sections.informationWeCollect.technicalInfo.title")}
          </h3>
          <p className="mb-4">{t("sections.informationWeCollect.technicalInfo.content")}</p>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">{t("sections.howWeUseInfo.title")}</h2>
          <ul className="list-disc pl-6 space-y-2">
            {Array.from({ length: 6 }, (_, i) => (
              <li key={`howWeUseInfo-point-${i + 1}`}>
                {t(`sections.howWeUseInfo.points.${i + 1}`)}
              </li>
            ))}
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            {Array.from({ length: 6 }, (_, i) => (
              <li key={`yourRights-point-${i + 1}`}>{t(`sections.yourRights.points.${i + 1}`)}</li>
            ))}
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <h3 className="text-xl font-medium mb-2">{t("sections.cookies.essential.title")}</h3>
          <p className="mb-4">{t("sections.cookies.essential.content")}</p>
          <h3 className="text-xl font-medium mb-2">{t("sections.cookies.analytics.title")}</h3>
