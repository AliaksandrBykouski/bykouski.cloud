...
export default async function NotFound() {
  ...
  const locale = cookie.includes("NEXT_LOCALE=cz") ? "cz" : "ru";
    ...
    <LocalLayout params={Promise.resolve({ locale } as { locale: string })}>
      <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <p className="text-6xl font-bold tracking-tight text-muted-foreground">404 - Not Found</p>
          <div className="mt-4">
            <h1 className="text-7xl font-bold tracking-tight text-foreground">{t("title")}</h1>
